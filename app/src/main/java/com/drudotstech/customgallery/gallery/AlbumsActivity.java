...
public class AlbumsActivity extends AppCompatActivity implements AlbumClickCallback {
    ...
    private final ActivityResultLauncher<Intent> picturesLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        @Override
