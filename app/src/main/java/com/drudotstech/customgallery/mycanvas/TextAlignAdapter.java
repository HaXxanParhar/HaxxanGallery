...
public class TextAlignAdapter extends RecyclerView.Adapter<TextAlignAdapter.ViewHolder> {

    private final Context context;
    private final List<AlignModel> list;
    private final AlignmentSelectionCallback callback;

    private int previousPosition = 0;

    public TextAlignAdapter(Context context, List<AlignModel> list, AlignmentSelectionCallback callback) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.design_text_align, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        AlignModel current = list.get(position);
        ...
        if (current != null) {
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    callback.onAlignmentSelected(position);
    ...
    public interface AlignmentSelectionCallback {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.iv_align);
        }
    }
}
