...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mCropOverlayView.setOnClickListener(view -> {
            Toast.makeText(context, "overlay", Toast.LENGTH_SHORT).show();
            Log.d("Clicked", "--------- overlay");
        });
        ...
        mCropOverlayView.setCropWindowChangeListener(
                new CropOverlayView.CropWindowChangeListener() {
                    ...
                    public void onCropWindowChanged(boolean inProgress) {
                        Toast.makeText(context, "crop window changed", Toast.LENGTH_SHORT).show();
...
// here
    ...
    private void handleCropWindowChanged(boolean inProgress, boolean animate) {
        //haxxan: this method is making the image zoom
        int width = getWidth();
