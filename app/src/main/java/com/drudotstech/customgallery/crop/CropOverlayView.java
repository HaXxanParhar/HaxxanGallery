...
//                rect.bottom = bottomLimit - verticalPadding;
                ...
                // haxxan : adding 0 padding for crop overlay
                rect.top = topLimit + verticalPadding;
                rect.bottom = bottomLimit - verticalPadding;
                ...
                // haxxan : adding 0 padding for crop overlay
                rect.left = leftLimit + 0;
                rect.right = rightLimit - 0;
...
//                canvas.drawRect(rect, mBorderPaint);
                ...
                float[] corners = new float[]{
                        40, 40,        // Top left radius in px
                        40, 40,        // Top right radius in px
                        40, 40,          // Bottom right radius in px
                        40, 40           // Bottom left radius in px
                };
    ...
    private void onActionMove(float x, float y) {
        // haxxan: uncomment to make the crop overlay movable
//        if (mMoveHandler != null) {
